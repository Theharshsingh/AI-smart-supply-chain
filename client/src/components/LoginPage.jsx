...
import { Rocket, Eye, EyeOff, AlertCircle, Loader2, LogIn, Shield, User } from 'lucide-react';
    ...
    <div style={{
      ...
      >
        ...
        >
          ...
          <motion.div
            style={{ fontSize: 24, fontWeight: 800, color: '#f1f5f9', letterSpacing: '-0.02em' }}
          >
            SupplyChain
          </motion.div>
          <motion.div
            style={{ fontSize: 13, color: '#475569', marginTop: 4, fontWeight: 500 }}
          >
            Guardian Platform
          </motion.div>
        </motion.div>
            ...
            >
              ...
              <div style={{ position: 'relative' }}>
                <span style={{
                  ...
                  zIndex: 1, color: '#475569', fontSize: 14, display: 'flex',
                }}>
                  <Shield size={14} />
                </span>
                <input
              ...
              <div style={{ position: 'relative' }}>
                ...
                <input
                  ...
                  style={{
                    width: '100%', background: 'rgba(255,255,255,0.04)',
                    border: '1.5px solid rgba(255,255,255,0.08)',
                    borderRadius: 12, padding: '12px 44px 12px 40px',
                    color: '#f1f5f9', fontSize: 14, outline: 'none',
                    fontFamily: 'inherit', boxSizing: 'border-box',
                    transition: 'border-color 0.2s, box-shadow 0.2s',
                    backdropFilter: 'blur(8px)',
          ...
          >
            ...
            <div style={{
              ...
              <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center' }}>
                <span style={{ fontSize: 11, color: '#60a5fa', fontWeight: 700, display: 'flex', alignItems: 'center', gap: 4 }}>
                  <Shield size={11} /> Admin
                </span>
                <span style={{ fontSize: 11, color: '#475569', fontFamily: 'monospace' }}>
                  admin@supplychain.com &nbsp;·&nbsp; admin123
                </span>
              </div>
              ...
              <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center' }}>
                ...
                <span style={{ fontSize: 11, color: '#475569', fontFamily: 'monospace' }}>
                  driver@supplychain.com &nbsp;·&nbsp; driver123
                </span>
              </div>
            </div>
          </motion.div>
